...
def get_agent_sequence(batch_size: int, score_ratio: int = 5):
    """
...
parser.add_argument(
    "--batch_size", type=float, help="Size of the batch in each round.")
...
sequence = get_agent_sequence(batch_size = args.batch_size)
...
file_path = f'{args.out_dir}/selection_batch_size_{args.batch_size}_{uuid.uuid4()}.json'
